...
2.  **Read the Guidelines:** Re-read [Role-Based Guidelines](../skills/resume_generation/rules/role_guidelines.md) for the specific role.
3.  **Read the Pillars:** Consult [Content Judgment Pillars](../skills/resume_generation/rules/content_judgment_pillars.md).
...
2.  **Regenerate & Audit:** Run `python3 .agent/scripts/generate_resume.py [YAML_PATH]` to generate the new `.tex` file. Then, use the [Resume Audit Protocol](./audit_resume.md) to ensure the 2-line visual symmetry rule hasn't been broken.
