...
## 3. Metric Estimation
If data is missing, derive it logically:
- **Time Saved:** "Saved 2 hours/week $\rightarrow$ 100+ hours/year".
- **Scale:** Identify the number of users, requests per second, or data volume.
- **Authority:** "Managed team of 10" vs "Led a cross-functional group".
